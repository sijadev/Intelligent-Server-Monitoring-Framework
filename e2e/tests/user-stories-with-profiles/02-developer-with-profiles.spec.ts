      ...
      [
        {
          ...
          context: 'Alex überprüft das System vor Docker Deployment basierend auf Docker Test Profil',
          action: async () => {
            ...
            console.log(`   - Erwartete Containerization Probleme: ${comparison.problems.expected}`);
        ...
        },
        {
          ...
          action: async () => {
            ...
            if (systemInfoVisible) {
              ...
              console.log(`🖥️ System Metrics für Docker Profile: ${metricsText?.substring(0, 200)}...`);
        ...
        },
        {
          ...
          action: async () => {
            ...
            if (newComparison.problems.actual <= newComparison.problems.expected * 1.2) {
              ...
              console.log(`⚠️  Probleme über Docker Profile Erwartung - Deployment Impact Review nötig`);
            }
      ...
      [
        {
          ...
          action: async () => {
            ...
            if (isCodeAnalysisAvailable) {
              ...
              console.log(`ℹ️  Code Analysis über Dashboard - High Complexity Daten interpretieren`);
            }
        ...
        },
        {
          ...
          action: async () => {
            ...
            console.log(`   - Log Entries Soll/Ist: ${comparison.logEntries.expected}/${comparison.logEntries.actual}`);
            console.log(`   - Problems Soll/Ist: ${comparison.problems.expected}/${comparison.problems.actual}`);
            console.log(`   - Metrics Soll/Ist: ${comparison.metrics.expected}/${comparison.metrics.actual}`);
            ...
            if (comparison.logEntries.actual > 50 || comparison.problems.actual > 10) {
              ...
              console.log(`📉 System läuft ruhiger als CI High Complexity Profil - möglicherweise positiv`);
            }
        ...
        },
        {
          ...
          action: async () => {
            ...
            console.log(`📊 Durchschnitt Response Time bei High Complexity: ${avgResponse.toFixed(0)}ms`);
      ...
      [
        ...
        },
        {
          ...
          action: async () => {
            ...
            const pluginCount = await page.textContent('[data-testid="plugins-card"] .count').catch(() => '0');
