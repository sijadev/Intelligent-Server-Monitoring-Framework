...
test.describe('🎯 Testprofil-Integration Test', () => {
  ...
  test('Test Template System mit CI High Complexity', async ({ page }) => {
    ...
    console.log(`   - Erwartete Log Entries: ${testTemplate['testProfile'].expectedData.logEntries}`);
    ...
    await test.step('Soll/Ist Vergleich durchführen', async () => {
      ...
      console.log(`   Problems: Soll=${comparison.problems.expected}, Ist=${comparison.problems.actual}, Match=${comparison.problems.match}`);
      console.log(`   Log Entries: Soll=${comparison.logEntries.expected}, Ist=${comparison.logEntries.actual}, Match=${comparison.logEntries.match}`);
      console.log(`   Metrics: Soll=${comparison.metrics.expected}, Ist=${comparison.metrics.actual}, Match=${comparison.metrics.match}`);
