              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <Progress 
                      value={(aiStats?.successRate || 0) * 100} 
                      className="mt-2" 
                    />
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">
                      {aiStats?.averageConfidence ? `${(aiStats.averageConfidence * 100).toFixed(1)}%` : '0%'}
                    </div>
                    <Progress 
                      value={(aiStats?.averageConfidence || 0) * 100} 
                      className="mt-2" 
                    />
                  </CardContent>
                </Card>
                        ...
                        <div key={deployment.id} className="flex items-center justify-between p-3 border rounded-lg">
                          <div className="flex-1">
                            ...
                            <div className="text-sm text-gray-500">
                              Started {formatTimeAgo(deployment.startTime)} by {deployment.initiatedBy}
                            </div>
                          </div>
                          ...
                          <div className="flex items-start justify-between">
                            <div className="flex-1">
                              ...
                              <div className="flex items-center gap-4 text-xs text-gray-500">
                                <span>Confidence: {(intervention.confidence * 100).toFixed(1)}%</span>
                            ...
                            <div className="flex-1">
                              ...
                              {deployment.filesChanged.length > 0 && (
                                <div className="text-xs text-gray-500">
                                  ...
                                  {deployment.filesChanged.length > 3 && ` +${deployment.filesChanged.length - 3} more`}
                                </div>
                              )}
                            </div>
                            <div className="ml-4">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-center py-8 text-gray-500">
                    ...
                    <br />
                    <span className="text-xs">This will show trained models, accuracy metrics, and training history</span>
                  </div>
                </CardContent>
              </Card>
            </TabsContent>
